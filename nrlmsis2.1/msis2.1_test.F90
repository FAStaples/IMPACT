...
program msistest
  ...
  open(77,file='msisinputs.txt',status='old')
  open(78,file='msisoutputs.txt',status='replace')
  ...
  do
    read(77,*, iostat=ios) iyd,sec,alt,glat,glong,stl,f107a,f107,apd
	if (ios /=0) exit ! exit loop on EOF or error
    ap(1) = apd
